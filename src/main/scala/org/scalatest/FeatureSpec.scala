...
trait FeatureSpec extends Suite { thisSuite =>
  ...
  protected def ignore(specText: String, testTags: Tag*)(testFun: => Unit) {
    registerIgnoredTest(Resources("scenario", specText), testFun _, "ignoreCannotAppearInsideAScenario", "FeatureSpec.scala", "ignore", 4, -2, None, testTags: _*)
  }
  ...
  protected def feature(description: String)(fun: => Unit) {
    ...
    registerNestedBranch(Resources("feature", description), None, fun, "featureCannotAppearInsideAScenario", "FeatureSpec.scala", "feature", 4, -2)
  }
