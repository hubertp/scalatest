...
class CatchReporterSuite extends Suite {
  ...
  def testCatching() {
    ...
    intercept[RuntimeException] {
      buggyReporter(TestSucceeded(new Ordinal(99), "suite name", "suite ID", Some("suite.className"), None, "test name", "test name", None, List.empty[Event]))
    }
    catchReporter(TestSucceeded(new Ordinal(99), "suite name", "suite ID", Some("suite.className"), None, "test name", "test name", None, List.empty[Event]))
    ...
    intercept[RuntimeException] {
      buggyReporter(TestFailed(new Ordinal(99), "message", "suite name", "suite ID", Some("suite.className"), None, "test name", "test name", None, List.empty[Event], None))
    }
    catchReporter(TestFailed(new Ordinal(99), "message", "suite name", "suite ID", Some("suite.className"), None, "test name", "test name", None, List.empty[Event], None))
