...
class ToleranceSpec extends Spec with NonImplicitAssertions with TripleEquals with UncheckedEquality with Tolerance {
    ...
    */
    ...
    def `should throw TestFailedException if the number is not within the specified range` { pending
      ...
      val caught1 = intercept[TestFailedException] {
        assert(sevenDotOh === (17.1 +- 0.2))
      }

      // Double +- Float
      val caught2 = intercept[TestFailedException] {
        assert(sevenDotOh === (17.1 +- 0.2f))
      }

      // Double +- Long
      val caught3 = intercept[TestFailedException] {
        assert(sevenDotOh === (17.1 +- 2L))
      }

      // Double +- Int
      val caught4 = intercept[TestFailedException] {
        assert(sevenDotOh === (17.1 +- 2))
      }

      // Double +- Short
      val caught5 = intercept[TestFailedException] {
        assert(sevenDotOh === (17.1 +- 2.toShort))
      }

      // Double +- Byte
      val caught6 = intercept[TestFailedException] {
        assert(sevenDotOh === (17.1 +- 2.toByte))
      }

      // Float +- Float
      val caught7 = intercept[TestFailedException] {
        assert(sevenDotOhFloat === (17.1f +- 0.2f))
      }

      // Float +- Long
      val caught8 = intercept[TestFailedException] {
        assert(sevenDotOhFloat === (17.1f +- 2L))
      }

      // Float +- Int
      val caught9 = intercept[TestFailedException] {
        assert(sevenDotOhFloat === (17.1f +- 2))
      }

      // Float +- Short
      val caught10 = intercept[TestFailedException] {
        assert(sevenDotOhFloat === (17.1f +- 2.toShort))
      }

      // Float +- Byte
      val caught11 = intercept[TestFailedException] {
        assert(sevenDotOhFloat === (17.1f +- 2.toByte))
      }

      // Long +- Long
      val caught12 = intercept[TestFailedException] {
        assert(sevenLong === (19L +- 2L))
      }

      // Long +- Int
      val caught13 = intercept[TestFailedException] {
        assert(sevenLong === (19L +- 2))
      }

      // Long +- Short
      val caught14 = intercept[TestFailedException] {
        assert(sevenLong === (19L +- 2.toShort))
      }

      // Long +- Byte
      val caught15 = intercept[TestFailedException] {
        assert(sevenLong === (19L +- 2.toByte))
      }

      // Int +- Int
      val caught16 = intercept[TestFailedException] {
        assert(sevenInt === (19 +- 2))
      }

      // Int +- Short
      val caught17 = intercept[TestFailedException] {
        assert(sevenInt === (19 +- 2.toShort))
      }

      // Int +- Byte
      val caught18 = intercept[TestFailedException] {
        assert(sevenInt === (19 +- 2.toByte))
      }

      // Short +- Short
      val caught19 = intercept[TestFailedException] {
        assert(sevenShort === (19.toShort +- 2.toShort))
      }

      // Short +- Byte
      val caught20 = intercept[TestFailedException] {
        assert(sevenShort === (19.toShort +- 2.toByte))
      }

      // Byte +- Byte
      val caught21 = intercept[TestFailedException] {
        assert(sevenByte === (19.toByte +- 2.toByte))
      }
    }
