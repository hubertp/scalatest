...
class ToleranceSpec extends Spec with NonImplicitAssertions with TripleEquals with UncheckedEquality with Tolerance {
  ...
  */
  object `The === syntax` {
    ...
    def `should be false if the number is outside the given interval` { pending
    ...
    def `should, for symmetry, be false if the number is outside the given interval, when the interval is placed on the left hand side` { pending
  ...
  object `The !== syntax` {
    ...
    def `should be false if the number is within the given interval` { pending
    ...
    def `should, for symmetry, be false if the number is within the given interval, when the interval is on the left hand side` { pending
